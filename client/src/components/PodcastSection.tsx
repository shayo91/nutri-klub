...
const podcastEpisodes: PodcastEpisode[] = [
  {
    id: 1,
    title: "Konačni Vodič za Uravnoteženu Ishranu",
    description:
      "Saznajte o esencijalnim hranljivim materijama koje vaše telo treba i kako stvoriti uravnoteženu ishranu koja podržava vaše ciljeve.",
    duration: "32:15",
    image:
      "https://images.unsplash.com/photo-1599508704512-2f19efd1e35f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    audioUrl: "#podcast-sample-1",
  },
  {
    id: 2,
    title: "Superhrana: Činjenice vs. Fantazije",
    description:
      "Razbijanje mitova o superhrani i naglašavanje stvarno hranljivih opcija koje zaslužuju mesto u vašoj ishrani.",
    duration: "28:45",
    image:
      "https://images.unsplash.com/photo-1490818387583-1baba5e638af?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    audioUrl: "#podcast-sample-2",
  },
  {
    id: 3,
    title: "Ishrana za Vrhunske Mentalne Performanse",
    description:
      "Otkrijte kako određene hrane i hranljive materije mogu poboljšati fokus, pamćenje i opštu kognitivnu funkciju.",
    duration: "37:20",
    image:
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-6">
            Slušajte Stručne Savete o Ishrani
          </h2>
          <p className="text-gray-600">
            Uključite se u naše podkaste za najnovije uvide u ishranu, intervjue
            sa stručnjacima i praktične savete za poboljšanje vašeg zdravstvenog
            putovanja.
          </p>
        </motion.div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    aria-label={
                      isPlaying ? "Pauzirajte podkast" : "Pustite podkast"
                    }
                  >
                    {isPlaying ? (
                      <svg
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="bg-primary bg-opacity-10 text-primary text-sm font-medium px-2 py-1 rounded">
                    Epizoda {episode.id}
                  </span>

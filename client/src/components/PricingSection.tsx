  ...
  return (
    <section id="pricing" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-primary font-medium tracking-wide uppercase mb-2">{t('pricing.subtitle')}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="p-8">
              <h3 className="text-xl font-bold mb-4">{t('pricing.plan1.title')}</h3>
              <div className="mb-6">
                <span className="text-4xl font-bold">€49</span>
                <span className="text-gray-500">/mesečno</span>
              </div>
              <p className="text-gray-600 mb-6">{t('pricing.plan1.description')}</p>
          ...
          >
            ...
            <div className="p-8 pt-10">
              <h3 className="text-xl font-bold mb-4">{t('pricing.plan2.title')}</h3>
              <div className="mb-6">
                <span className="text-4xl font-bold">€89</span>
                <span className="text-gray-500">/mesečno</span>
              </div>
              <p className="text-gray-600 mb-6">{t('pricing.plan2.description')}</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
          ...
          >
            <div className="p-8">
              <h3 className="text-xl font-bold mb-4">{t('pricing.plan3.title')}</h3>
              <div className="mb-6">
                <span className="text-4xl font-bold">€149</span>
                <span className="text-gray-500">/mesečno</span>
              </div>
              <p className="text-gray-600 mb-6">{t('pricing.plan3.description')}</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                ...
                <li className="flex items-center">
                  ...
                  <span>24/7 direktan pristup nutricionistu</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>

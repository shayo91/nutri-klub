export const translations = {
  ...
  sr: {
    ...
    'about.description1': 'Ja sam sertifikovani nutricionista sa Master diplomom iz Nauke o Ishrani i preko 10 godina iskustva u pomaganju klijentima da transformišu svoje zdravlje kroz personalizovane planove ishrane.',
    'about.description2': 'Moj pristup kombinuje naučno znanje sa praktičnim, održivim rešenjima koja odgovaraju vašem načinu života. Verujem da ishrana treba da bude prijatna, a ne ograničavajuća, i da male, dosledne promene vode do izuzetnih rezultata.',
